                    ...
                    <div class="card-block">
                        ...
                        <?php echo e($question->title); ?> 
                            <span class="float-xs-right">
                                <a href="/survey/reviewed/<?php echo e($question->token); ?>">All Reviewed Survey <i class="icon-arrow-right2"></i></a>
                            </span>
                        </p>
                    </div>
                    <div class="table-responsive">
                        ...
                        <div style="padding: 5%;">
                            <?php if(count($answers) == 0): ?>
                                No responses has been yet made to this Survey. Yet you can visit reviewed if there are any. View <a href="/survey/reviewed/<?php echo e($question->token); ?>" class="btn btn-sm btn-default">Reviewed</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
