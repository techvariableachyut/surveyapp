...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item">
              <a href="{{ URL::asset('/') }}" class="navbar-brand nav-link">
                <img alt="branding logo" 
                src="{{ URL::asset('/app-assets/images/logo/logo.png') }}" 
                data-expand="{{ URL::asset('/app-assets/images/logo/logo.png') }}" 
                data-collapse="{{ URL::asset('/app-assets/images/logo/logo-small.png') }}" 
                class="brand-logo">
              </a>
    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="{{ URL::asset("/dashboard") }}"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span></a>
          ...
          <li class=" nav-item"><a href="#"><i class="icon-paper"></i><span data-i18n="nav.survey.main" class="menu-title">Survey</span></a>
            <ul class="menu-content">
              <li><a href="{{ URL::asset("/create/question") }}" data-i18n="nav.survey.create" class="menu-item">Create Survey</a></li>
              <li><a href="{{ URL::asset("/survey/all") }}" data-i18n="nav.survey.create" class="menu-item">All Survey</a></li>
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{{ URL::asset("/app-assets/js/scripts/pages/dashboard-lite.js") }}" type="text/javascript"></script>
    <script>
      var csrfToken = "{{ Session::token() }}";
    </script>
    <script src="{{ URL::asset("/js/surveylist.js") }}"></script>
    <!-- END PAGE LEVEL JS-->
    @yield("script")
    @yield("editscript")
    <script src="{{ URL::asset("/js/charts/charts.js") }}" type="text/javascript"></script>
  </body>
</html>
